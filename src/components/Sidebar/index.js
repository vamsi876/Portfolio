...
import LogoE from '../../assets/images/V.png'
    ...
    return(
        <div className = 'nav-bar'> 
            ...
            <ul>
                ...
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://github.com/vamsi876">
                        <FontAwesomeIcon icon={faGithub} color = "#4d4d4e" />
                    </a>
                </li>
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://www.instagram.com/vamsikrishnakollipara/">
